...
from ..auth.dependency import get_current_user, require_enable_banking_owner
...
def sync_transactions(
    request: Request, body: SyncRequest, current_user: User = Depends(require_enable_banking_owner)
) -> SyncResponse:
